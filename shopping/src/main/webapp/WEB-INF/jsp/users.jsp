									...
									<div class="card card-profile">
										<div class="card-avatar">
											<a href="#pablo"> <img class="img"
												src="http://localhost/images/sysadmin.png" />
											</a>
										</div>
										<div class="content">
											<h6 class="category text-gray">Sysadmin</h6>
							...
							<c:if test="${username.equalsIgnoreCase('sysadmin')}">
								<div class="col-md-4">
									<div class="card card-profile">
										...
										<div class="content">
											<h6 class="category text-gray">SYS ADMIN</h6>
											<h4 class="card-title">Vinay</h4>
											<p class="card-content">Email: ${emailID}</p>
											<a href="<c:url value="/edituser/sysadmin"/>"
												class="btn btn-primary btn-round">Edit</a> <a href="#pablo"
												class="btn btn-primary btn-round">Create new User</a>
										</div>
									</div>
								</div>
							</c:if>						
