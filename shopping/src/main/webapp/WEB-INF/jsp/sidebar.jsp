<div class="sidebar" data-color="purple"
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            <li ${page.equals("Dashboard")?"class='active'":""}><a href="<c:url value="/dashboard"/>"> <i
                        class="material-icons">dashboard</i>
                    <p>Dashboard</p>
                </a></li>
            <li ${page.equals("Profile")?"class='active'":""}><a href="<c:url value="/users"/>"> <i class="material-icons">person</i>
                    <p>User Profile</p>
                </a></li>
