		...
		<div class="card card-container">
			...
			<form method="POST" action="<c:url value="/adminlogin"/>"
				...
				<span id="reauth-email" class="reauth-email"></span> <input
					...
					placeholder="Email address" required autofocus value="${emailID}" />
				<input type="password" name="password" class="form-control"
					placeholder="Password" required value="${password}" />
				<!-- instead of request.getParameter in jsp param.paramname is used in JSTL -->
				<input type="hidden" name="reqpage" value="${req}" />
				...
				<table align="center">
					<tr>
						...
						<td style="font-style: italic; color: red;">${param.msg}</td>
					</tr>
