...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="<c:url value="/resources/images/apple-icon.png"/>" />
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-color="purple" data-image="<c:url value="/resources/images/sidebar-1.jpg"/>">
            <!--
